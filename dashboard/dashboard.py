...
# Baca File csv
data_day_df = pd.read_csv("https://raw.githubusercontent.com/alifya15/Bike-Rental-Data-Analysis/main/dashboard/main_data.csv")
...
with st.sidebar:
    st.image("https://raw.githubusercontent.com/alifya15/Bike-Rental-Data-Analysis/main/dashboard/logo.jpg")
